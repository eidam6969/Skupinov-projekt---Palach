...
def start_game():
    # --- TADY JE TA OPRAVA (GLOBAL) ---
    global score, game_over, user_name, name_entered, current_enemy_speed, highscore
    ...
    while running:
        ...
        if not game_over:
            ...
            if name_entered:
                screen.blit(font.render("ULOŽENO! (Zavři křížkem pro Menu)", True, (0, 255, 0)), (screen_width // 2 - 130, screen_height // 2 + 100))
